...
print('-'*120)
print('{:<15}'.format('Interface') + '{:<3}'.format(':') + f'{show_interface[0]:<20}')
print('{:<15}'.format('IP Address') + '{:<3}'.format(':') + f'{show_interface[1]:<20}')
print('{:<15}'.format('Status') + '{:<3}'.format(':') + f'{show_interface[5]:<20}')
